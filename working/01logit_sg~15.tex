...
%% Biogeme 2.7b
%% Compiled biogeme 2.7b [Wed Feb 14 17:16:31 CET 2018]
%% <a href='http://people.epfl.ch/michel.bierlaire'>Michel Bierlaire</a>, <a href='http://transp-or.epfl.ch'>Transport and Mobility Laboratory</a>, <a href='http://www.epfl.ch'>Ecole Polytechnique F&eacute;d&eacute;rale de Lausanne (EPFL)</a>
%% Report created on Wed Feb 14 17:32:09 2018
  \begin{tabular}{l}
...
\multicolumn{3}{l}{ Number of estimated  parameters = $4$} \\
 $\mathcal{L}(\beta_0)$ &=&  $-170300587.644$ \\
 $\mathcal{L}(\hat{\beta})$ &=& $-5331.252 $  \\
 $-2[\mathcal{L}(\beta_0) -\mathcal{L}(\hat{\beta})]$ &=& $340590512.785$ \\
    $\rho^2$ &=&   $1.000$ \\
    $\bar{\rho}^2$ &=&    $1.000$ \\
\end{tabular}
  \end{tabular}
