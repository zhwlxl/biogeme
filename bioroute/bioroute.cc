...
//   }
   ...
   stringstream str1 ;
   str1 << theNetwork.getName() << ".gp" ;
   stringstream str2 ;
   str2 << theNetwork.getName() << ".net" ;
   stringstream str3 ;
   str3 << theNetwork.getName() << ".pat" ;
   theNetwork.createGnuplotFile(patString(str1.str()),
				patString(str2.str()),
				patString(str3.str()),
				err) ;
   if (err != NULL) {
   ...
   stringstream str4 ;
   str4 << theNetwork.getName() << ".stat" ;
   theNetwork.createPathStatistics(patString(str4.str()),err) ;
   if (err != NULL) {
     WARNING(err->describe()) ;
     exit(-1) ;
   }

   bioStateRepository::the()->print("listOfStates.log") ;
