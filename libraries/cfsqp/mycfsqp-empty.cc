...
resign(int,int,patReal *,patReal *,patReal *,struct _constraint *,
       patReal *,int,int);
static void     sbout1(FILE *,int,char *,patReal,patReal *,int,int);
static void     sbout2(FILE *,int,int,char *,char *,patReal *);
 ...
 */
{
  WARNING("****************************************************************") ;
  WARNING("") ;
  WARNING(" If you read this message, it means that either you are running a") ;
  WARNING(" pre-compiled version of BIOGEME, or that you have not obtained the") ;
  WARNING(" file cfsqp.c ") ;
  WARNING(" CFSQP is licensed software, and cannot be distributed with BIOGEME.") ;
  WARNING(" Please find the relevant information below.") ;
  WARNING("") ;
  WARNING(" BIOGEME allows you to run two other algorithms: SOLVOPT and DONLP2.") ;
  WARNING("") ;
  WARNING("****************************************************************") ;
  WARNING("*                       CFSQP  Version 2.5d") ;
  WARNING("*                  Craig Lawrence, Jian L. Zhou") ;
  WARNING("*                         and Andre Tits") ;
  WARNING("*                  Institute for Systems Research") ;
  WARNING("*                               and") ;
  WARNING("*                Electrical Engineering Department") ;
  WARNING("*                     University of Maryland") ;
  WARNING("*                     College Park, Md 20742") ;
  WARNING("*                  Conditions for External Use") ;
  WARNING("*                  ===========================") ;
  WARNING("*   1. The CFSQP routines may not be distributed to third parties.") ;
  WARNING("*      Interested parties shall contact AEM Design directly.") ;
  WARNING("*   2. If modifications are performed on the routines, these") ;
  WARNING("*      modifications shall be communicated to AEM Design.  The") ;
  WARNING("*      modified routines will remain the sole property of the authors.") ;
  WARNING("*   3. Due acknowledgment shall be made of the use of the CFSQP") ;
  WARNING("*      routines in research reports or publications. Whenever") ;
  WARNING("*      such reports are released for public access, a copy shall") ;
  WARNING("*      be forwarded to AEM Design.") ;
  WARNING("*   4. The CFSQP routines may only be used for research and") ;
  WARNING("*      development, unless it has been agreed otherwise with AEM") ;
  WARNING("*      Design in writing.") ;
  WARNING("* Copyright (c) 1993-1998 by Craig T. Lawrence, Jian L. Zhou, and") ;
  WARNING("*                         Andre L. Tits") ;
  WARNING("* All Rights Reserved.") ;
  WARNING("*") ;
  WARNING("* Enquiries should be directed to:") ;
  WARNING("*      AEM Design") ;
  WARNING("*      2691 Smoketree Way") ;
  WARNING("*      Atlanta, GA 30345") ;
  WARNING("*      U. S. A.") ;
  WARNING("*      Phone : 770-934-0174") ;
  WARNING("*      Fax   : 770-939-8365") ;
  WARNING("*      E-mail: info@aemdesign.com") ;
  WARNING("****************************************************************") ;
  WARNING("PLEASE CHANGE THE gevAlgo ENTRY IN THE PARAMETER FILE.") ;
  WARNING("****************************************************************") ;
  exit(-1) ;
   return;
}
...
#ifdef __STDC__
static void
sbout1(FILE *io,int n,char *s1,patReal z,patReal *z1,int job,int level)
#else
...
#ifdef __STDC__
static void
sbout2(FILE *io,int n,int i,char *s1,char *s2,patReal *z)
#else
...
patBoolean patCfsqp::isAvailable() {
  return patFALSE ;
}
