...
out(int,int,int,int,int,int,int,int,int,int,int,int *,patReal *,
    struct _constraint *,struct _objective *,patReal,
    patReal,patReal,patReal,patReal,int, patString);
static void
 ...
 */
{
 ...
 L910:
  ...
  cfsqp1(miter,nparam,nob,nobL,nfsip1,nineqn,neq,neqn,ncsipl1,ncsipn1,
	 ...
	 indxcn,param,cs,ob,signeq,obj,constr,gradob,gradcn, stopFile);
...
out(int miter,int nparam,int nob,int nobL,int nfsip,int ncn,
    ...
    patReal steps,patReal sktnom,patReal d0norm,int feasb,patString stopFile)
#else
  static void
out(miter,nparam,nob,nobL,nfsip,ncn,nn,nineqn,ncnstr,ncsipl,ncsipn,
    mesh_pts,x,cs,ob,fM,fmax,steps,sktnom,d0norm,feasb, stopFile)
