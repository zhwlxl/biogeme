//-*-c++-*------------------------------------------------------------
//
// File name : bioArithIntegral.h
// Author :    Michel Bierlaire
// Date :      Tue Mar 30 17:33:52 2010
//
//--------------------------------------------------------------------

#ifndef bioArithIntegral_h
#define bioArithIntegral_h
...
*/
class bioArithIntegral : public bioArithUnaryExpression {

public:
  
  bioArithIntegral(bioExpressionRepository* rep,
		   patULong par,
		   patULong left,
...
public:
  ...
  virtual bioExpression* getDerivative(patULong aLiteralId, 
				       patError*& err) const ;
  virtual bioArithIntegral* getDeepCopy(bioExpressionRepository* rep,
					patError*& err) const ;
  virtual bioArithIntegral* getShallowCopy(bioExpressionRepository* rep,
					patError*& err) const ;
